    ...
    return (
        <div className="header-action mt-lg-3 text-right">
            ...
            <div className='lang-action'>
                <a onClick={onChangeLang.bind(this, '')} ><img src={prefixer('/images/lang/eng.png')} alt='english' /></a>
                <a onClick={onChangeLang.bind(this, 'jp')} ><img src={prefixer('/images/lang/japan.png')} alt='english' /></a>
